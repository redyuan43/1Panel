...
description: "基于 MiniMax H3 参考图生视频 的 AI 视频生成器，固定调用 MiniMax H3 的参考图生视频裸接口能力。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、参考图生视频、图片参考生视频、参考图片生成视频、风格参考视频、角色参考视频、AI视频、视频生成 时使用此 Skill。"
description_zh: "基于 MiniMax H3 参考图生视频 的 AI 视频生成器，固定调用 MiniMax H3 的参考图生视频裸接口能力。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、参考图生视频、图片参考生视频、参考图片生成视频、风格参考视频、角色参考视频、AI视频、视频生成 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `minimax-h3-image-reference-to-video` 搜索入口，不与其他模型或能力 Skill 合并
