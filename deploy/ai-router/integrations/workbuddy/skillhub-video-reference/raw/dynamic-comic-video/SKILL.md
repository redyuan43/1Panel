...
description: "基于 动态漫画 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 动态漫画、动态漫、漫画转视频、漫画动起来、动画分镜、二次元动画、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
description_zh: "基于 动态漫画 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 动态漫画、动态漫、漫画转视频、漫画动起来、动画分镜、二次元动画、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `dynamic-comic-video` 搜索入口，不与其他模型或能力 Skill 合并
