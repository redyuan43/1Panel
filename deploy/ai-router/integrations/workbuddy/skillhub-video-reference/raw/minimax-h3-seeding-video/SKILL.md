...
description: "基于 MiniMax H3 种草视频 的 AI 视频生成器，使用 MiniMax H3 制作种草视频。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、种草视频、小红书种草、抖音种草、社媒种草、好物推荐、UGC种草、AI视频、视频生成 时使用此 Skill。"
description_zh: "基于 MiniMax H3 种草视频 的 AI 视频生成器，使用 MiniMax H3 制作种草视频。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、种草视频、小红书种草、抖音种草、社媒种草、好物推荐、UGC种草、AI视频、视频生成 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `minimax-h3-seeding-video` 搜索入口，不与其他模型或能力 Skill 合并
