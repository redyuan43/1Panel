...
description: "基于 电商视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 电商视频、电商广告、商品视频、电商主图视频、详情页视频、SKU视频、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
description_zh: "基于 电商视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 电商视频、电商广告、商品视频、电商主图视频、详情页视频、SKU视频、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `ecommerce-video` 搜索入口，不与其他模型或能力 Skill 合并
