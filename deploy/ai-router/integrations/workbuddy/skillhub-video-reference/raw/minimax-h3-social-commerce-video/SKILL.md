...
description: "基于 MiniMax H3 带货视频 的 AI 视频生成器，使用 MiniMax H3 制作带货视频。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、带货视频、直播带货、短视频带货、商品种草、转化视频、卖货视频、AI视频、视频生成 时使用此 Skill。"
description_zh: "基于 MiniMax H3 带货视频 的 AI 视频生成器，使用 MiniMax H3 制作带货视频。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、带货视频、直播带货、短视频带货、商品种草、转化视频、卖货视频、AI视频、视频生成 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `minimax-h3-social-commerce-video` 搜索入口，不与其他模型或能力 Skill 合并
