---
name: minimax-h3
description: "基于 MiniMax H3 视频生成 的 AI 视频生成器，覆盖 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频 的裸接口与全部公开模式。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧 时使用此 Skill。"
description_zh: "基于 MiniMax H3 视频生成 的 AI 视频生成器，覆盖 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频 的裸接口与全部公开模式。当用户需要 MiniMax H3、MiniMaxH3、海螺 H3、Hailuo H3、海螺视频、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `minimax-h3` 搜索入口，不与其他模型或能力 Skill 合并
