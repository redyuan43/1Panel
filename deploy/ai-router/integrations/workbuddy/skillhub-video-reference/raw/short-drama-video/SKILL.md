...
description: "基于 短剧视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 短剧视频、AI短剧、微短剧、剧情短片、故事视频、连续剧片段、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
description_zh: "基于 短剧视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 短剧视频、AI短剧、微短剧、剧情短片、故事视频、连续剧片段、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `short-drama-video` 搜索入口，不与其他模型或能力 Skill 合并
