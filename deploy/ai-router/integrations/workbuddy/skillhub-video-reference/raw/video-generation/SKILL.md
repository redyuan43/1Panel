...
description: "基于 AI 视频生成 的 AI 视频生成器，通用能力搜索入口，按输入素材自动选择文生视频、图生视频或参考生视频裸接口。当用户需要 AI 视频生成、AIGC视频、AI视频、视频制作、生成视频、Seedance、MiniMax H3、Happy Horse 时使用此 Skill。"
description_zh: "基于 AI 视频生成 的 AI 视频生成器，通用能力搜索入口，按输入素材自动选择文生视频、图生视频或参考生视频裸接口。当用户需要 AI 视频生成、AIGC视频、AI视频、视频制作、生成视频、Seedance、MiniMax H3、Happy Horse 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `video-generation` 搜索入口，不与其他模型或能力 Skill 合并
