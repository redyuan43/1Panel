---
name: ai-ad-video
description: "基于 AI 广告视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 AI 广告视频、AI广告、广告片、品牌广告、商业广告、信息流广告、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
description_zh: "基于 AI 广告视频 的 AI 视频生成器，通用商业场景搜索入口，底层调用 AI Hive 裸接口。当用户需要 AI 广告视频、AI广告、广告片、品牌广告、商业广告、信息流广告、Seedance、MiniMax H3、Happy Horse、AI视频 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `ai-ad-video` 搜索入口，不与其他模型或能力 Skill 合并
