---
name: image-to-video
description: "基于 图生视频 的 AI 视频生成器，不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力。当用户需要 图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成 时使用此 Skill。"
description_zh: "基于 图生视频 的 AI 视频生成器，不限定用户必须知道模型名，使用 AI Hive 裸接口完成该能力。当用户需要 图生视频、图片生成视频、图片转视频、image to video、I2V、首帧生视频、Seedance、MiniMax H3、Happy Horse、AI视频、视频生成 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `image-to-video` 搜索入口，不与其他模型或能力 Skill 合并
